...
public class TicketValidationController {
	...
	@Operation(summary = "Validate a ticket", description = "Scan a QR code to validate a ticket for the given event. Only staff members assigned to the event may call this endpoint.", responses = {
	...
	public ResponseEntity<TicketValidationResponse> validateTicket(
			@Parameter(description = "Event identifier", required = true) @PathVariable("eventId") UUID eventId,
			@Parameter(description = "Staff user identifier", required = true) @RequestHeader("X-User-Id") UUID staffId,
	...
	@Operation(summary = "List ticket validations", description = "List all validation attempts for the event so staff can audit scans.", responses = {
