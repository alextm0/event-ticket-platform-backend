...
public interface TicketTypeMapper {
	...
	@Mapping(expression = "java(ticketType.getTotalQuantity() > 0 ? Math.max(0.0, Math.min((double) ticketType.getSoldCount() / ticketType.getTotalQuantity(), 1.0)) : 0.0)", target = "soldRatio")
